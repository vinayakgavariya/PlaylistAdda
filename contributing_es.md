...
<!-- > Si quiere hacer una pregunta, suponemos que ha leído la [Documentación] disponible(). -->
...
Si luego sigue sintiendo la necesidad de hacer una pregunta y necesita una aclaración, le recomendamos lo siguiente:
...
<!--
Es posible que quieras crear una etiqueta de cuestión separada para las preguntas e incluirla en esta descripción. La gente debería entonces etiquetar sus cuestiones en consecuencia.

Dependiendo de lo grande que sea el proyecto, es posible que quieras externalizar las preguntas, por ejemplo, a Stack Overflow o Gitter. Puedes añadir posibilidades de contacto e información adicionales:
- IRC
- Slack
- Gitter
- Stack Overflow tag
...
<!-- Es posible que quieras crear un issue template para bugs y errores, que puedan ser utilizada como guía y que defina la estructura de la información a incluir. Si lo haces, haz referencia a ella aquí en la descripción. -->
...
<!-- Puede que quieras crear una plantilla de tema para las sugerencias de mejora que pueda ser utilizada como guía y que defina la estructura de la información a incluir. Si lo haces, haz referencia a ella aquí en la descripción. -->
### Tú primera contribución
<!-- TODO
¿Incluye la configuración del entorno, el IDE y las típicas instrucciones de inicio?
